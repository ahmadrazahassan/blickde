...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/softwareprodukt-zur-pruefung-einreichen" },
};
...
export default function SubmitSoftwarePage() {
  return (
    <>
      <PageHeader
        crumbs={[{ label: "Software eintragen", href: "/softwareprodukt-zur-pruefung-einreichen" }]}
        micro="Für Anbieter"
          ...
          <div className="grid gap-12 lg:grid-cols-[minmax(0,44rem)_minmax(0,1fr)] lg:gap-16">
            <div className="prose-editorial">
              ...
              <p>
                ...
                <Link href="/transparenz-zu-affiliate-links">Affiliate-Hinweis</Link> namentlich offengelegt und
            ...
            <aside className="lg:sticky lg:top-[89px] lg:self-start">
              <Card className="p-5">
                ...
                <div className="mt-5">
                  <ButtonLink href="/kontakt-zur-redaktion" variant="primary" block>
                    Zum Kontaktformular
