...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/kontakt-zur-redaktion" },
};
...
const ANLIEGEN = [
  ...
  },
  {
    ...
    link: { label: "Was wir aufnehmen", href: "/softwareprodukt-zur-pruefung-einreichen" },
  },
  {
    icon: IconReview,
    ...
    link: { label: "Redaktionsrichtlinien", href: "/redaktionelle-richtlinien-und-pruefprozess" },
  },
];
...
export default function ContactPage() {
  return (
    <>
      <PageHeader
        crumbs={[{ label: "Kontakt", href: "/kontakt-zur-redaktion" }]}
        micro="Kontakt"
                ...
                <Card className="p-6">
                  ...
                  <p className="mt-4 flex items-start gap-2.5 text-[13px] leading-[1.6] text-[var(--color-ink-3)]">
                    ...
                    <span>
                      ...
                      <Link href="/anbieterkennzeichnung-und-impressum" className="link-red">
                        Impressum
                      </Link>
                      .
                    </span>
