...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/unternehmenssoftware-vergleichen" },
};
...
export default async function SoftwareIndexPage({
  ...
  function facetHref(changes: Record<string, string | string[] | undefined>) {
    ...
    return qs ? `/unternehmenssoftware-vergleichen?${qs}` : "/unternehmenssoftware-vergleichen";
  }
  ...
  return (
    <>
      <PageHeader
        wide
        crumbs={[{ label: "Software", href: "/unternehmenssoftware-vergleichen" }]}
          ...
          <div className="grid gap-9 lg:grid-cols-[minmax(0,14rem)_minmax(0,1fr)] lg:gap-10">
            ...
            <aside aria-labelledby="filter-heading" className="lg:sticky lg:top-[89px] lg:self-start">
              <div className="flex items-center justify-between gap-3 pb-3">
                ...
                {filterCount > 0 ? (
                  <Link href="/unternehmenssoftware-vergleichen" className="text-[13px] text-[var(--color-primary)] hover:text-[var(--color-primary-hover)]">
                    Zurücksetzen
                  </Link>
                ) : null}
              </div>
            ...
            <div className="min-w-0">
              ...
              <Pagination
                ...
                basePath="/unternehmenssoftware-vergleichen"
                query={{
