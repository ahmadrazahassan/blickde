...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/unternehmenssoftware-vergleichen/${item.slug}/vergleichbare-alternativen` },
  };
}
    ...
    <>
      <PageHeader
        crumbs={[
          ...
          { label: "Alternativen", href: `/unternehmenssoftware-vergleichen/${item.slug}/vergleichbare-alternativen` },
        ]}
        micro="Alternativen"
                ...
                {all.map((row) => (
                  ...
                  >
                    <th scope="row" className="py-3.5 pr-4 text-left font-normal">
                      <Link
                        href={`/unternehmenssoftware-vergleichen/${row.slug}`}
        ...
        <div className="container-page">
          ...
          <Card className="mt-10 p-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              ...
              <ButtonLink href={`/software-im-direktvergleich?a=${item.slug}`} variant="secondary" className="shrink-0">
                <IconCompare size={18} />
                Vergleich starten
              </ButtonLink>
            </div>
