...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/unternehmenssoftware-vergleichen/${item.slug}/erfahrungen-und-bewertungen/bewertung-verfassen` },
    ...
    <>
      <PageHeader
        ...
        crumbs={[
          ...
          { label: "Schreiben", href: `/unternehmenssoftware-vergleichen/${item.slug}/erfahrungen-und-bewertungen/bewertung-verfassen` },
        ]}
