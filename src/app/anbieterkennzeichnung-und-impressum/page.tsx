...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/anbieterkennzeichnung-und-impressum" },
};
...
export default function ImprintPage() {
  return (
    <>
      <PageHeader
        crumbs={[{ label: "Impressum", href: "/anbieterkennzeichnung-und-impressum" }]}
            ...
            <aside className="lg:sticky lg:top-[89px] lg:self-start">
              <Card className="p-5">
                ...
                <ul className="mt-3.5 flex flex-col gap-2.5">
                  {[
                    { label: "Datenschutzerklärung", href: "/datenschutzerklaerung-und-privatsphaere" },
                    { label: "Cookie-Richtlinie", href: "/cookie-richtlinie-und-einstellungen" },
                    { label: "Nutzungsbedingungen", href: "/nutzungsbedingungen-der-website" },
                    { label: "Barrierefreiheit", href: "/erklaerung-zur-barrierefreiheit" },
                    { label: "Affiliate-Hinweis", href: "/transparenz-zu-affiliate-links" },
                  ].map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
