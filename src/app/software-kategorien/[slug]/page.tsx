...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/software-kategorien/${category.slug}` },
  };
}
...
export default async function CategoryPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const jsonLd = {
    ...
    url: `${siteSettings.url}/software-kategorien/${category.slug}`,
  ...
  return (
    <>
      <PageHeader
        crumbs={[
          { label: "Kategorien", href: "/software-kategorien" },
          { label: category.name, href: `/software-kategorien/${category.slug}` },
        ]}
        micro="Kategorie"
        title={`${category.name} im Test`}
            ...
            <EmptyState
              ...
              action={
                <div className="flex flex-wrap gap-3">
                  <ButtonLink href="/software-kategorien" variant="secondary">
                    Andere Kategorien ansehen
                  </ButtonLink>
                  <ButtonLink href="/softwareprodukt-zur-pruefung-einreichen" variant="quiet">
        ...
        <section className="section border-t border-[var(--color-rule)]">
          <div className="container-page">
            <SectionHead
              ...
              action={
                <ButtonLink href="/ratgeber-fuer-unternehmenssoftware" variant="secondary">
                  Alle Beiträge
