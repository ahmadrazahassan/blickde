  ...
  return (
    <>
      <PageHeader
        ...
        meta={
          <form action="/suche" method="get" role="search" className="flex max-w-[36rem] gap-2.5">
        ...
        <div className="container-page">
          {query.length < 2 ? (
            ...
            <EmptyState
              ...
              action={
                <div className="flex flex-wrap gap-3">
                  ...
                  <ButtonLink href="/kategorien" variant="quiet">
            ...
            >
              ...
              <Link href="/software-eintragen" className="link-red">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[var(--color-rule)] pb-4">
                ...
                <nav aria-label="Trefferart" className="flex flex-wrap items-center gap-1">
                  ...
                  {KIND_ORDER.filter((k) => hits.some((h) => h.kind === k)).map((k) => (
                    <Link
                      key={k}
                      href={`/suche?q=${encodeURIComponent(query)}&art=${k}`}
