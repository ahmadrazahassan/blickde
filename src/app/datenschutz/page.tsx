...
export default function PrivacyPage() {
  return (
    <>
      <PageHeader
        crumbs={[{ label: "Datenschutz", href: "/datenschutz" }]}
        micro="Datenschutz"
        title="Datenschutzerklärung"
        ...
        <div className="container-page">
          <div className="grid gap-12 lg:grid-cols-[minmax(0,44rem)_minmax(0,1fr)] lg:gap-16">
            <div className="prose-editorial">
              ...
              <p>
                Wenn Sie das Formular auf der Seite <Link href="/kontakt">Kontakt</Link> absenden,
              ...
              <p>
                ...
                <Link href="/newsletter/abmelden">Newsletter abbestellen</Link>. Eine Anmeldung
              ...
              <p>
                ...
                <Link href="/kontakt">Redaktionsadresse</Link> verlangen. Wie eine Bewertung
              ...
              <p>
                ...
                <Link href="/affiliate-hinweis">Affiliate-Hinweis</Link> namentlich nennen.
              </p>
              ...
              <p>
                ...
                <Link href="/kontakt">Kontaktformular</Link>. Wir antworten innerhalb der Frist des
