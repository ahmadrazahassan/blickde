...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/software/${item.slug}/bewertungen` },
  };
}
...
export default async function ReviewsPage({
  ...
  function href(changes: Record<string, string | undefined>) {
    ...
    return qs ? `/software/${slug}/bewertungen?${qs}` : `/software/${slug}/bewertungen`;
  }
          ...
          <div className={cx("mt-14 grid gap-10", all.length > 0 ? "lg:grid-cols-[minmax(0,14rem)_minmax(0,1fr)] lg:gap-12" : "mx-auto max-w-[60rem]")}>
            ...
            <div className="min-w-0">
              ...
              {visible.length === 0 ? (
                <div>
                  {all.length === 0 ? <div className="rounded-[18px] border border-[#dce6f1] bg-[#f8faff] p-7 md:p-10">
                    ...
                    <div className="mt-6"><ButtonLink href={`/software/${item.slug}/bewertungen/neu`} variant="primary">Bewertung schreiben ↗</ButtonLink></div>
                    ...
                    action={
                      <ButtonLink
                        href={`/software/${item.slug}/bewertungen/neu`}
                        variant="secondary"
                      >
                        Bewertung schreiben
                      </ButtonLink>
              ...
              <Pagination
                ...
                basePath={`/software/${slug}/bewertungen`}
                query={{
                  sterne: query.sterne,
