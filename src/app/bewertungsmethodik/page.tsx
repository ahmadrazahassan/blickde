...
export default async function MethodologyPage() {
  ...
  return (
    <>
      <PageHeader
        crumbs={[{ label: "Bewertungsmethodik", href: "/bewertungsmethodik" }]}
        micro="Verfahren"
          ...
          <div className="grid gap-12 lg:grid-cols-[minmax(0,44rem)_minmax(0,1fr)] lg:gap-16">
            <div className="prose-editorial">
              ...
              <p>
                ...
                <Link href="/affiliate-hinweis">Affiliate-Hinweis</Link>, die redaktionellen Regeln
                stehen in den <Link href="/redaktionsrichtlinien">Redaktionsrichtlinien</Link>.
              </p>

              <h2 id="korrektur">Korrekturen</h2>
              <p>
                Wenn Ihnen an einer Bewertung oder an einer Angabe etwas falsch erscheint, schreiben
                Sie uns über das <Link href="/kontakt">Kontaktformular</Link>. Wir prüfen jeden
