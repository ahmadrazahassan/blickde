...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/presse-und-medieninformationen" },
};
...
export default function PressPage() {
  return (
    <>
      <PageHeader
        crumbs={[{ label: "Presse", href: "/presse-und-medieninformationen" }]}
        micro="Presse"
          ...
          <div className="grid gap-12 lg:grid-cols-[minmax(0,44rem)_minmax(0,1fr)] lg:gap-16">
            <div className="prose-editorial">
              ...
              <p>
                ...
                <Link href="/transparenz-zu-affiliate-links">Affiliate-Hinweis</Link>. Provisionen haben keinen
