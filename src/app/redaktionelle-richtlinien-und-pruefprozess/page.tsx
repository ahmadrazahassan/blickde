...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/redaktionelle-richtlinien-und-pruefprozess" },
};
...
export default function EditorialPolicyPage() {
  return (
    <>
      <PageHeader
        crumbs={[{ label: "Redaktionsrichtlinien", href: "/redaktionelle-richtlinien-und-pruefprozess" }]}
          ...
          <div className="grid gap-12 lg:grid-cols-[minmax(0,44rem)_minmax(0,1fr)] lg:gap-16">
            <div className="prose-editorial">
              ...
              <p>
                ...
                <Link href="/transparenz-zu-affiliate-links">Affiliate-Hinweis</Link>.
              </p>
