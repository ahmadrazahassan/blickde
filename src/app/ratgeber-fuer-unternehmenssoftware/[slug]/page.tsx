...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/ratgeber-fuer-unternehmenssoftware/${article.slug}` },
    openGraph: {
      type: "article",
      title: article.meta_title,
      description: article.meta_description,
      url: `${siteSettings.url}/ratgeber-fuer-unternehmenssoftware/${article.slug}`,
...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const jsonLd = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${siteSettings.url}/ratgeber-fuer-unternehmenssoftware/${article.slug}`,
    },
  };
            ...
            <div className="flex justify-center">
              <Breadcrumb
                items={[
                  ...
                  { label: article.title, href: `/ratgeber-fuer-unternehmenssoftware/${article.slug}` },
                ]}
              />
            </div>
