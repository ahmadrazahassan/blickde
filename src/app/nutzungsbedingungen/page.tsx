...
export default function TermsPage() {
  return (
    <>
      <PageHeader
        crumbs={[{ label: "Nutzungsbedingungen", href: "/nutzungsbedingungen" }]}
      ...
      <ProseSection>
        ...
        <p>
          ...
          <Link href="/redaktionsrichtlinien">Redaktionsrichtlinien</Link> beschriebenen Verfahren
        ...
        <p>
          Wenn Ihnen ein Fehler auffällt, <Link href="/kontakt">melden Sie ihn uns</Link>. Wir
        ...
        <p>
          ...
          <Link href="/affiliate-hinweis">Affiliate-Hinweis</Link>. Auf Noten und Reihenfolge hat
