...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/ueber-softwareblick-und-unsere-mission" },
};
...
export default async function AboutPage() {
  ...
  return (
    <>
      <PageHeader
        crumbs={[{ label: "Über uns", href: "/ueber-softwareblick-und-unsere-mission" }]}
        micro="Über uns"
          ...
          <div className="prose-editorial mx-auto max-w-[44rem]">
            ...
            {mitVereinbarung ? (
              <p>
                ...
                <Link href="/transparenz-zu-affiliate-links">Affiliate-Hinweis</Link>. Betroffene Links sind vor
              ...
              <p>
                ...
                <Link href="/transparenz-zu-affiliate-links">Affiliate-Hinweis</Link> namentlich genannt und der
        ...
        <div className="container-page">
          ...
          <div className="mx-auto mt-12 max-w-[42rem]">
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <ButtonLink href="/kontakt-zur-redaktion" variant="primary">
                Redaktion kontaktieren
                <IconArrowRight size={18} />
              </ButtonLink>
              <ButtonLink href="/redaktionelle-richtlinien-und-pruefprozess" variant="secondary">
