...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/cookie-richtlinie-und-einstellungen" },
};
...
export default function CookiePolicyPage() {
  return (
    <>
      <PageHeader
        crumbs={[{ label: "Cookie-Richtlinie", href: "/cookie-richtlinie-und-einstellungen" }]}
      ...
      <ProseSection>
        ...
        <p>
          ...
          steht in der <Link href="/datenschutzerklaerung-und-privatsphaere">Datenschutzerklärung</Link>.
        </p>
      </ProseSection>
    </>
  );
